...
/*
void AdditionalLights_Pure(int iterator, float3 WorldPos, out float3 Direction, out float3 Color, out float DistanceAtten)
{
UNITY_INITIALIZE_OUTPUT(float3, Direction);
	...
	Light light = GetAdditionalLight(iterator, WorldPos);
